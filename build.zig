...
pub fn build(b: *Builder) void {
    ...
    if (for_wasm) {
        ...
        lib.linkSystemLibrary("../wasi-libc/sysroot/lib/wasm32-wasi/libc.a");
        lib.linkSystemLibrary("../wasi-libc/sysroot/lib/wasm32-wasi/libwasi-emulated-mman.a");
        lib.linkSystemLibrary("../wasi-libc/sysroot/lib/wasm32-wasi/libwasi-emulated-signal.a");

        lib.defineCMacro("__wasi__");
        lib.defineCMacro("_WASI_EMULATED_MMAN");
        lib.defineCMacro("_WASI_EMULATED_SIGNAL");
        lib.defineCMacro("wchar_t=int");
        ...
        lib.addSystemIncludeDir("../wasi-libc/sysroot/include");
        lib.addSystemIncludeDir("../wasi-libc/libc-top-half/musl/arch/generic/");
        lib.addIncludeDir("build/src/libAtomVM/");
        lib.addIncludeDir("../wasi-libc/libc-top-half/musl/include");
